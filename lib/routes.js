...
Router.route('/projects/:_id', {
  name: 'projectDetails',
  waitOn: function() {
    return [Meteor.subscribe('hearings'), Meteor.subscribe('projects'), Meteor.subscribe('courts'), Meteor.subscribe('lawyers'), Meteor.subscribe('clients'), Meteor.subscribe('meetings'), Meteor.subscribe('tasks'), Meteor.subscribe('events'), Meteor.subscribe('labels')];
  },
