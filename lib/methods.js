...
var removeData = function(collection, role){
	return function(_id){
		authenticate(role);
		if(_id)
...
Meteor.methods({
	...
	'saveCourtData': upsertData(Courts, 'edit-courts'),
  	...
  	'removeProject': removeData(Projects, 'edit-projects'),
	'removeHearing': removeData(Hearings, 'edit-hearings'),
	'removeTask': removeData(Tasks, 'edit-tasks'),
	'removeMeeting': removeData(Meetings, 'edit-meetings'),
	'removeTimesheet': removeData(Timesheets, 'edit-timesheets'),
	'removeCourt': removeData(Courts, 'edit-courts'),
  	'removeLabel': removeData(Labels, 'edit-labels'),
  	'removeGroup': removeData(Groups, 'edit-groups'),
  	'removeClient': removeData(Users, 'edit-clients'),
  	'removeLawyer': removeData(Users, 'edit-lawyers'),
