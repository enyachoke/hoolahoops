...
Router.route('/timesheets/:_id/edit',{
	...
	data : function(){ return Timesheets.findOne({caseId : this.params._id }); }
});
...
Router.route('/projects/:_projectId/meetings/add', {
  name: 'addMeeting',
  waitOn: function() {
		return [ Meteor.subscribe('meetings'), Meteor.subscribe('lawyers'), Meteor.subscribe('projects') ];
...
Router.route('/projects/:_id', {
  name: 'projectDetails',
  waitOn: function() {
    return [Meteor.subscribe('hearings'), Meteor.subscribe('projects'), Meteor.subscribe('courts'), Meteor.subscribe('lawyers'), Meteor.subscribe('clients'), Meteor.subscribe('meetings'), Meteor.subscribe('tasks'), Meteor.subscribe('events'), Meteor.subscribe('labels'), Meteor.subscribe('orders')];
  },
