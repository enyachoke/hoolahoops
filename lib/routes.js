...
Router.route('/projects', {
  name: 'projects',
  waitOn: function () {
    return [Meteor.subscribe('projects'), Meteor.subscribe('clients'), Meteor.subscribe('lawyers'), Meteor.subscribe('hearings'), Meteor.subscribe('labels')];
  }
});
...
Router.route('/projects/:_id/edit', {
  name: 'projectEdit',
  waitOn: function() {
    return [Meteor.subscribe('hearings'), Meteor.subscribe('projects'), Meteor.subscribe('courts'), Meteor.subscribe('lawyers'), , Meteor.subscribe('labels')];
  },
  data: function () { return Projects.findOne(this.params._id);  }
});
